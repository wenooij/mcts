...
func TestBackpropFeatures(t *testing.T) {
	...
	s := &Search{
		SearchInterface: &dummySearch{BranchFactor: 1, Rand: r},
		Rand:            r,
		NumEpisodes:     3,
	}
	s.Search()
